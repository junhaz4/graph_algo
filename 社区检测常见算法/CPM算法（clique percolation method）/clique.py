...
if __name__ == "__main__":
     ...
     c_A = list(nx.community.k_clique_communities(H, 4))#查找具有社团结构的网络：地图，最小团块大小 ：完全连接K个节点的子图
     ...
     c_B = list(nx.community.k_clique_communities(B, 5))#查找具有社团结构的网络：地图，最小团块大小 ：完全连接K个节点的子图
